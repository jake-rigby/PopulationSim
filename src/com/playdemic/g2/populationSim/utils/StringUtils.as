package com.playdemic.g2.populationSim.utils
{
	public class StringUtils
	{
		...
		public static function getFormatedDateOutput(d:Date):String
		{
			...
			var s:String =
				...
				DAYS[d.day]+' '+MONTHS[d.month]+' '+d.date+ORDINALS[ord]+' '+d.fullYearUTC;
			return s;
		}
